...
- (void)viewDidLoad {
    ...
    // NOTE: Sidebar = Source List = NSOutlineView
    // TODO: create App Store or Adblock Plus like interface:
    // Full Size Content translucent sidebar (while still being able to drag the window on
    // the top sidebar)
    // NOTE: App Store allows window dragging in the entire sidebar. So it probably involves
...
// Entry point we do not reach
// We should reach this before applicationDidFinishLaunching
// Yyyess!! We get here now. Outline is filled but item text is not drawn. Why???
